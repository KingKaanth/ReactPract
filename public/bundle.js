...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Services = __webpack_require__(219);
	var SubcribeForm = __webpack_require__(220);
	...
	ReactDOM.render(React.createElement(
	    ...
	    React.createElement(
	        ...
	        React.createElement(IndexRoute, { component: SubcribeForm })
	    )
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'form',
	                    { className: 'form-signin', ref: 'postForm', onSubmit: this.createPost },
	                    React.createElement(
	                        'h3',
	                    ...
	                    React.createElement(
	                        'button',
	                        { className: 'btn btn-sm btn-primary btn-block', type: 'submit' },
	                        'Subcribe'
	                    )
	                ),
	                React.createElement(Message, { email: emailId, res: response })
	            )
	        );
	    }
	});
